...
class AlbumLikesHandler {
  ...
  async postLikeHandler(request, h) {
    ...
    //   const {albumId} = request.params;
      ...
      const albumId = id;
      console.log(`ini album id ${albumId}`);
      console.log(`ini id ${id}`);
      const {id: credentialId} = request.auth.credentials;
      console.log(`ini credentialid ${credentialId}`);
  ...
  async getLikeHandler(request, h) {
    ...
    //   const {albumId} = request.params;
      ...
      const albumId = id;
      console.log(`Pembuka==========================================`);
      console.log(`ini albumid pada getlikehandler ${albumId}`);

      const data = await this._service.getLikesCount(albumId);
      console.log(`ini data user_album_likes ${data}`);
